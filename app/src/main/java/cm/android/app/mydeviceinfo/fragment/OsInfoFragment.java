...
public class OsInfoFragment extends ListInfoFragment {

    public static OsInfoFragment newInstance(int sectionNumber) {
        OsInfoFragment fragment = new OsInfoFragment();
